const Skeleton = () => {
    return (
      ...
      <div className="flex items-center justify-center h-72 mb-4 bg-gray-300 rounded-sm dark:bg-gray-700">
      ...
      <div className="flex items-center mt-4">
         <svg className="w-10 h-10 me-3 text-gray-200 dark:text-gray-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div>
              {/* Increase the width here from w-32 to w-48 */}
              <div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-48 mb-2"></div>
              {/* Increase the width here from w-48 to w-64 */}
              <div className="w-64 h-2 bg-gray-200 rounded-full dark:bg-gray-700"></div>
          </div>
      </div>
      {/* Increase the width here from w-48 to w-64 */}
      <div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-64 mb-4 mt-4"></div>
